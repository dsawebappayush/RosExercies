...
if("TRUE" STREQUAL "TRUE")
  set(smb_highlevel_controller_SOURCE_PREFIX /home/ayush/ex-2_try23/src/smb_highlevel_controller)
  set(smb_highlevel_controller_DEVEL_PREFIX /home/ayush/ex-2_try23/devel)
  ...
  set(smb_highlevel_controller_INSTALL_PREFIX /home/ayush/ex-2_try23/install)
...
if(NOT "/home/ayush/ex-2_try23/src/smb_highlevel_controller/include " STREQUAL " ")
  set(smb_highlevel_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/ayush/ex-2_try23/src/smb_highlevel_controller/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'smb_highlevel_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ayush/ex-2_try23/src/smb_highlevel_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ayush/ex-2_try23/devel/lib;/opt/ros/noetic/lib)
